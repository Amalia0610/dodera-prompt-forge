...
// Block HTML / script tags and common injection markers
...
/* ── Honeypot field name (hidden from real users, bots fill it) */
...
export function ContactForm() {
    ...
    function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        // Rate-limit: max 3 submissions per 60 s
        const now = Date.now();
        ...
        // Sanitise all values before sending
